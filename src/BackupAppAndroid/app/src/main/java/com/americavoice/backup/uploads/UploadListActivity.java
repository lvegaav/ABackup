...
import com.americavoice.backup.utils.AnalyticsUtils;
...
import static com.americavoice.backup.Const.PREFERENCE_EXPERT_MODE;
...
public class UploadListActivity extends FileActivity implements UploadListFragment.ContainerActivity {
    ...
    public static Intent getCallingIntent(Context context) {
        return new Intent(context, UploadListActivity.class);
    }
