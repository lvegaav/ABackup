...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response,
        ...
        Account[] accounts = accountManager.getAccountsByType(BaseConstants.ACCOUNT_TYPE);
        ...
        if (accounts.length < 1) {
            ...
            intent.putExtra(BaseConstants.EXTRA_ACTION, LoginActivity.ACTION_CREATE);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response,
        ...
        String accessToken;
        if (authTokenType.equals(AccountTypeUtils.getAuthTokenTypePass(BaseConstants.ACCOUNT_TYPE))) {
        ...
        if (accessToken != null) {
            ...
            result.putString(AccountManager.KEY_ACCOUNT_TYPE, BaseConstants.ACCOUNT_TYPE);
        ...
        intent.putExtra(KEY_AUTH_TOKEN_TYPE, authTokenType);
        intent.putExtra(KEY_LOGIN_OPTIONS, options);
        intent.putExtra(BaseConstants.EXTRA_ACCOUNT, account);
        intent.putExtra(BaseConstants.EXTRA_ACTION, LoginActivity.ACTION_UPDATE_EXPIRED_TOKEN);
    ...
    private void validateAccountType(String type) throws UnsupportedAccountTypeException {
        if (!type.equals(BaseConstants.ACCOUNT_TYPE)) {
            throw new UnsupportedAccountTypeException();
        }
    }

    private void validateAuthTokenType(String authTokenType) throws UnsupportedAuthTokenTypeException {
        if (!authTokenType.equals(BaseConstants.AUTHORITY) &&
            !authTokenType.equals(AccountTypeUtils.getAuthTokenTypePass(BaseConstants.ACCOUNT_TYPE)) &&
            !authTokenType.equals(AccountTypeUtils.getAuthTokenTypeAccessToken(BaseConstants.ACCOUNT_TYPE)) &&
            !authTokenType.equals(AccountTypeUtils.getAuthTokenTypeRefreshToken(BaseConstants.ACCOUNT_TYPE)) &&
            !authTokenType.equals(AccountTypeUtils.getAuthTokenTypeSamlSessionCookie(BaseConstants.ACCOUNT_TYPE))) {
