    ...
    public static List<MediaFolder> getMediaFolders(ContentResolver contentResolver, int itemLimit,
        ...
        if (!PermissionUtil.checkSelfPermission(activity.getApplicationContext(),
            ...
            if (PermissionUtil.shouldShowRequestPermissionRationale(activity,
                ...
                Snackbar snackbar = Snackbar.make(activity.findViewById(R.id.fl_fragment),
                        R.string.files_permission_storage_access, Snackbar.LENGTH_INDEFINITE)
                        .setAction(R.string.common_ok, new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                PermissionUtil.requestWriteExternalStoragePermission(activity);
                            }
                        });
        ...
        String dataPath = AndroidApplication.getStoragePath() + File.separator + AndroidApplication.getDataFolder();
