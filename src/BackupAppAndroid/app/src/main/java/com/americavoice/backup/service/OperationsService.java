...
import com.americavoice.backup.operations.CheckCurrentCredentialsOperation;
import com.americavoice.backup.operations.CopyFileOperation;
...
import com.americavoice.backup.operations.MoveFileOperation;
import com.americavoice.backup.operations.RemoveFileOperation;
import com.americavoice.backup.operations.RenameFileOperation;
...
import com.americavoice.backup.operations.common.SyncOperation;
    ...
    public void onDestroy() {
        ...
        try {
            OwnCloudClientManagerFactory.getDefaultSingleton().
                    saveAllClients(this, BaseConstants.ACCOUNT_TYPE);
                ...
                try {
                    ...
                    if (mLastTarget == null || !mLastTarget.equals(next.first)) {
                        ...
                        if (mLastTarget.mAccount != null) {
                            ...
                            OwnCloudVersion version = AccountUtils.getServerVersion(mLastTarget.mAccount, mService);
    ...
    private Pair<Target , RemoteOperation> newOperation(Intent operationIntent) {
        ...
        try {
            if (!operationIntent.hasExtra(EXTRA_ACCOUNT) && 
                ...
                if (action.equals(ACTION_GET_SERVER_INFO)) {
                ...
                } if (action.equals(ACTION_GET_USER_NAME)) {
                    // Get User Name
                    ...
                    operation = new RenameFileOperation(getApplicationContext(), remotePath, newName);
