...
package com.americavoice.backup.syncadapter;
...
import com.americavoice.backup.utils.DataHolderUtil;
...
//            }
     ...
     * @param result            Result of an individual.
     */
    ...
    private void notifyFailedSynchronization() {
        ...
        if (needsToUpdateCredentials) {
            ...
            updateAccountCredentials.putExtra(BaseConstants.EXTRA_ACCOUNT, getAccount());
            updateAccountCredentials.putExtra(BaseConstants.EXTRA_ACTION,
     ...
     */
    private void notifyFailsInFavorites() {
        if (mFailedResultsCounter > 0) {
            NotificationCompat.Builder notificationBuilder = createNotificationBuilder();
            notificationBuilder.setTicker(i18n(R.string.sync_fail_in_favorites_ticker));
            ...
            notificationBuilder
                ...
                .setContentTitle(i18n(R.string.sync_fail_in_favorites_ticker))
                .setContentText(i18n(R.string.sync_fail_in_favorites_content,
                        mFailedResultsCounter + mConflictsFound, mConflictsFound));
            
            showNotification(R.string.sync_fail_in_favorites_ticker, notificationBuilder);
        } else {
            NotificationCompat.Builder notificationBuilder = createNotificationBuilder();
            notificationBuilder.setTicker(i18n(R.string.sync_conflicts_in_favorites_ticker));
            ...
            notificationBuilder
                ...
                .setContentTitle(i18n(R.string.sync_conflicts_in_favorites_ticker))
                .setContentText(i18n(R.string.sync_conflicts_in_favorites_ticker, mConflictsFound));
            
            showNotification(R.string.sync_conflicts_in_favorites_ticker, notificationBuilder);
        } 
    }
