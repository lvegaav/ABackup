...
public class ConfirmationActivity extends BaseActivity implements HasComponent<AppComponent>,
    ...
    private void initializeActivity(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            addFragment(R.id.fl_fragment, ConfirmationFragment.newInstance());
        }
    }
