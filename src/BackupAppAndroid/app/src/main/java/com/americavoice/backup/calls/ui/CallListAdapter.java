...
public class CallListAdapter extends RecyclerView.Adapter<CallListFragment.ContactItemViewHolder> {
    private List<VCard> vCards;
    private Set<Integer> checkedVCards;

    private Context context;

    CallListAdapter(Context context, List<VCard> vCards) {
        this.vCards = vCards;
    ...
    @Override
    public CallListFragment.ContactItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.contactlist_list_item, parent, false);

        return new CallListFragment.ContactItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final CallListFragment.ContactItemViewHolder holder, final int position) {
